...
const reviews: Review[] = [
  ...
  {
    rating: 5,
    comment: "Εξαιρετικοί επαγγελματίες! Μας καθοδήγησαν με σαφήνεια και συνέπεια σε κάθε στάδιο της διαδικασίας κατοχύρωσης σήματος, απαντώντας άμεσα και με προθυμία σε κάθε ερώτημά μας. Η ευγένεια, η επαγγελματική προσέγγιση και η προσήλωση στη λεπτομέρεια αποτυπώνονται σε κάθε τους ενέργεια. Τους συστήνουμε ανεπιφύλακτα.",
    author: "Opto Hellas"
