...
const stats: Stat[] = [
  { id: 's1', value: 140, label: 'Partners' },
  { id: 's2', value: 1100, suffix: '+', label: 'People' },
  { id: 's3', value: 120, label: 'Revenue (m)' },
  { id: 's4', value: 700, suffix: '+', label: 'Lawyers and legal professionals' },
  { id: 's5', value: 42, suffix: '%', label: 'Female partners' },
  { id: 's6', value: 42, label: 'UK law.com' }
];
